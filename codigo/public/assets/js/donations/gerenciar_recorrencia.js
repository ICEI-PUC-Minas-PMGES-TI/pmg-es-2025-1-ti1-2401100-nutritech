document.addEventListener('DOMContentLoaded', () => {
    ...
    console.log('Elementos DOM:', { lista, info, formEditar, formEditarPessoais });
    ...
    function checkLoginAndLoadData() {
        ...
        // Tentar diferentes chaves de sessão
        let usuarioCorrente = null;
        try {
            usuarioCorrente = JSON.parse(sessionStorage.getItem('currentUser'));
        } catch (e) {
        ...
        if (!usuarioCorrente) {
            try {
                usuarioCorrente = JSON.parse(localStorage.getItem('currentUser'));
            } catch (e) {
        ...
        console.log('Usuário encontrado:', usuarioCorrente);
        
        if (!usuarioCorrente || !usuarioCorrente.id) {
            console.log('Usuário não encontrado ou sem ID, redirecionando para login');
