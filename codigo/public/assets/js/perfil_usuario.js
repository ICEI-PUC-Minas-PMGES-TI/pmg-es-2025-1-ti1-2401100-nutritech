document.addEventListener('DOMContentLoaded', async function() {
    ...
    document.getElementById('foto-doador').src = currentUser.fotoPerfil || 'assets/images/usuario.png';
    document.querySelector('.d-flex.justify-content-center.align-items-center.flex-column.mb-4 h1').textContent = currentUser.nome || 'Usuário';
